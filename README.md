...
국군 의료 상담 AI챗봇 및 플랫폼 **_Meditact_**
...
- "챗봇 페이지"
  1. 챗봇 페이지의 프론트는 [오픈소스 Alpha](https://github.com/IcaliaLabs/alpha)를 활용하였습니다. 코드가 직관적이고 커스터마이징이 편하다는 장점이 있었습니다.
- "공지사항 페이지"
...
서버 실행 전 Mongod이 실행 중인지 확인한다.

또한, 설정 해놓은 환경변수의 문제가 없는 지 확인한다.
